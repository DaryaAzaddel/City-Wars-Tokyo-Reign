...
public class login2Controller {
    ...
    public void login(){
        ...
        User user = new User("saba","Ss12345_","sab","s@gmail.com");
        User user1 = new User("darya","Dd12345_","sab","s@gmail.com");
        user.setCharacter("Hulk");
        user1.setCharacter("Shehulk");
        RegisterController.users.add(user);
        RegisterController.users.add(user1);
